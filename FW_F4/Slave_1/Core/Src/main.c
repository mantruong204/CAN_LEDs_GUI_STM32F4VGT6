...
uint8_t TIM_cnt = 0,CAN_TX_count=0;
...
//		TxHeader.StdId = 0x0B;
//
//		uint16_t test_adc_val = 3977;
//
//		TxData[0] = (uint8_t)((test_adc_val & 0xFF00) >> 8);
//		TxData[1] = (uint8_t)((test_adc_val & 0x00FF) >> 0);
//
